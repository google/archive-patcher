...
/**
 * @Caution Don't change the class name or package, crash in native library is consequences.
 */
public class CustomDeflater extends Deflater {
     ...
     */
    public CustomDeflater(int level, boolean nowrap) {
        this.level = level;
     ...
     * @param level the compression level (0-9)
     */
    public CustomDeflater(int level) {
        this(level, false);
    }
