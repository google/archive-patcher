...
public class PreDiffPlanEntryTest {
  ...
  private static final PreDiffPlanEntry DEFAULT_QUALIFIED_RECOMMENDATION =
      getEntryBuilderWithCompressedBytesChanged().setZipEntries(ENTRY1, ENTRY2).build();
  ...
  private static final PreDiffPlanEntry ALTERED_ENTRY1 =
      getEntryBuilderWithCompressedBytesChanged().setZipEntries(ENTRY2, ENTRY2).build();
  private static final PreDiffPlanEntry ALTERED_ENTRY2 =
      getEntryBuilderWithCompressedBytesChanged().setZipEntries(ENTRY1, ENTRY1).build();
