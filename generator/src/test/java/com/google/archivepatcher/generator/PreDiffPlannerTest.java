...
import static com.google.archivepatcher.generator.PreDiffPlanEntryTestUtils.getEntryBuilderWithDeflateUnsuitable;
...
public class PreDiffPlannerTest {
  ...
  private static final List<DeltaFormat> BSDIFF_ONLY =
  ...
  private void checkPreDiffPlanEntry(PreDiffPlan plan, PreDiffPlanEntry... expected) {
    Assert.assertNotNull(plan.getPreDiffPlanEntries());
    Assert.assertEquals(expected.length, plan.getPreDiffPlanEntries().size());
  ...
  public void testGeneratePreDiffPlan_OneCompressedEntry_Unchanged() throws IOException {
    ...
    checkPreDiffPlanEntry(
        plan,
        getEntryBuilderWithCompressedBytesIdentical()
  ...
  public void testGeneratePreDiffPlan_OneCompressedEntry_LengthsChanged() throws IOException {
    ...
    checkPreDiffPlanEntry(
        plan,
        getEntryBuilderWithCompressedBytesChanged()
  ...
  public void testGeneratePreDiffPlan_OneUncompressedEntry() throws IOException {
    ...
    checkPreDiffPlanEntry(
        plan,
        getEntryBuilderWithBothEntriesUncompressed()
  ...
  public void testGeneratePreDiffPlan_OneEntry_UncompressedToUndivinable() throws IOException {
    ...
    checkPreDiffPlanEntry(
        plan,
        getEntryBuilderWithDeflateUnsuitable()
            .setZipEntries(findEntry(oldFile, ENTRY_A_STORED), findEntry(newFile, ENTRY_A_LEVEL_6))
            .build());
  }
  ...
  public void testGeneratePreDiffPlan_TwoDifferentEntries_DifferentPaths() throws IOException {
    ...
    Assert.assertTrue(plan.getOldFileUncompressionPlan().isEmpty());
    Assert.assertTrue(plan.getNewFileUncompressionPlan().isEmpty());
    Assert.assertTrue(plan.getPreDiffPlanEntries().isEmpty());
  }
