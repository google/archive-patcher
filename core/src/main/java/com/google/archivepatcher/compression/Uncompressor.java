 ...
 * <p>
 * In practice uncompressors are used to uncompress the deltas that were
 * compressed by a {@link Compressor} during generation of a patch. The
 * uncompressor can also be used to uncompress data in the source archives that
 * is currently compressed.
 * <p>
 */
public interface Uncompressor {
    ...
    /**
     * Returns the unique ID of this uncompressor. This should match the ID
